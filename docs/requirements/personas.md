...
- Runs and maintains the server. Comfortable with config, containers, networks.
...
## P2 — The Household Viewer (family)

- Watches on the lounge TV / their own devices. Not technical.
...
## P3 — The Travelling Viewer (you, remote)
